...
<body>
    ...
    if (isset($_POST["passwordlen"])) {
        ...
        $str2 = substr($str2, 10, $_POST["passwordlen"]);
        echo "<center><h1>Your Random Password = $str2</h1></center>";
        echo "<center><h6>$str1</h6></center>";
    }
    ?>
    ...
    <form class="container" action="index.php" method="POST">
        <div class="col-auto">
            ...
            <input type="number" name="passwordlen" class="form-control" id="inputPasswordlength" value="10" placeholder="Enter Password Length"><br>
        </div>
        <div class="col-auto">
